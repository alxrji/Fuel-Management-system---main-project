    ...
    <body>
        ...
        <div class="container bootdey">
            <div class="row">
              ...
              <img src="images/icon/logo.png" alt="FUEL" width="45px" height="45 px" style="margin-top:20px;"/>
            </a><br>
                            <h3 class="widget-title grey lighter">
                            <i class="fa-regular fa-file-invoice"></i>
                                Receipt
                            </h3>
                            <div class="widget-toolbar no-border invoice-info" style="margin-top:-60px;">
                                <span class="invoice-info-label">Invoice id:</span>
                                <span class="red">#121212</span>
                                <br>
                                <span class="invoice-info-label">Date:</span>
                                <span class="blue"><?=$row['date']?></span>
                            </div>
                            <div class="widget-toolbar hidden-480"" style="margin-top:-60px;">
