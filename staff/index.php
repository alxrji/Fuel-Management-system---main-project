                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub active">
                            <a class="js-arrow" href="orderhistory.php">
                                <i class='bi bi-bag-check-fill'></i>User Orders</a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane  fade  active show" id="orders" role="tabpanel" aria-labelledby="orders-tab">
                                ...
                                if(isset($_POST['invoice'])){
                                    ...
                                    $acpt_query = "UPDATE `tbl_order` SET `Invoice`='1' WHERE `order_id`='$orderid'";
                                    $acpt_query_rum = mysqli_query($conn, $acpt_query);
                                }
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <p class="text-dark">Name : <?php
                                                                                     echo $row['fname']." ". $row['lname']; 
                                                                                    ?> 
                                                    </p>
                                                    <a href="#">
                                                        <span class="float-right text-info">Fuel type : <?php
                                                                                                         echo $row['fuel'];
                                            ...
                                            <p class="text-gray mb-1"><i class="icofont-location-arrow"></i> 730 S Mendenhall Rd, Memphis, TN 38117, USA
                                                    ...
                                                    <p class="text-gray mb-3"><i class="icofont-list"></i> ORDER #<?php
                                                                                                                     echo $row['order_id']; 
                                                                                                                    ?> <i class="icofont-clock-time ml-2"></i>Date :
                                                        <?php
                                                           echo $row['date']; 
                                                        ?></p>
                                                    <p class="text-dark">Quantity : <?php
                                                                                     echo $row['quantity']; 
                                                                                    ?> L
                                                    </p>
                                                    <hr>
                                                    <div class="float-right">
                                                        <button class="btn btn-sm btn-outline-primary" name="invoice" value="<?php echo $row['order_id'];  ?>"><i class="icofont-headphone-alt"></i>ACCEPT</button>
                                                        <!-- <button class="btn btn-sm btn-primary" href="#"><i class="icofont-refresh"></i> REORDER</button> -->
                                                    </div>
                                                    <p class="mb-0 text-black text-primary pt-2"><span class="text-black font-weight-bold"> Total Paid:</span> <?php echo "Rs.". $row['price'] ?>
